  ...
  return (
    <body>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to John
        McCants.
      </p>{" "}
      <p>
        John McCants is committed to ensuring that the app is as useful and
      ...
      <p>
        The Presently App app stores and processes personal data that you have
        ...
        features and it could mean that the Presently App app won’t work
        properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that John McCants will
        ...
        Wi-Fi or provided by your mobile network provider, but John McCants
      ...
      <p>
        Along the same lines, John McCants cannot always take responsibility for
        ...
        avail the Service, John McCants cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to John McCants’s responsibility for your use of the app,
        ...
        it available to you. John McCants accepts no liability for any loss,
      ...
      <p>
        ...
        updates if you want to keep using the app. John McCants does not promise
      ...
      <p>
        ...
        do not hesitate to contact me at johnmccants002@gmail.com.
      </p>{" "}
      <p>
