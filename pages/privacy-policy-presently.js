...
export default function PrivacyPolicyPresently() {
  return (
    <body>
      <strong>Privacy Policy</strong>{" "}
      <p>
        John McCants built the Presently App app as a Free app. This SERVICE is
        provided by John McCants at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Presently App unless
